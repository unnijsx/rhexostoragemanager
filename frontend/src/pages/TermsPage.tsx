        ...
        <div className="space-y-8 text-slate-300 text-sm md:text-base leading-relaxed">
          <section className="card p-6 md:p-8 rounded-2xl">
            ...
            <p className="text-slate-400">
              By accessing and using Rheox, you agree to comply with and be bound by these Terms and Conditions. If you do not agree, you must not access or use the application.
            </p>
          </section>
          ...
          <section className="card p-6 md:p-8 rounded-2xl">
            ...
            <p className="text-slate-400">
              Rheox operates as a storage gateway and integrates with third-party storage providers. We do not assume responsibility for the availability, storage limits, data losses, or policies of those third-party services (such as Google Drive or your S3 host).
            </p>
          </section>
          ...
          <section className="card p-6 md:p-8 rounded-2xl">
            ...
            <p className="text-slate-400">
              Rheox is provided "as is" and "as available". We do not guarantee uninterrupted, secure, or error-free operations. We shall not be liable for any indirect, incidental, or consequential damages resulting from your use of the application.
            </p>
          </section>
        </div>
      </main>
